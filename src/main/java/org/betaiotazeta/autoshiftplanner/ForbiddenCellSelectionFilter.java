 ...
 * @author betaiotazeta
 */
public class ForbiddenCellSelectionFilter implements SelectionFilter<Solution, ChangeMove<Solution>> {

    @Override // short version: only checking the timeGrain
    public boolean accept(ScoreDirector<Solution> scoreDirector, ChangeMove<Solution> changeMove) {
        Object object = changeMove.getToPlanningValue();
        if (object instanceof TimeGrain) {
